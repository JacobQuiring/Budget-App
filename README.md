# Budget-App
The third certification project for Freecodecamp's 'Scientific Computing with Python' course. This program provides a class that contains budgeting tools, such as depositing, withdrawing, and transferring, for individual categories, and a function that collates those categories into an expense chart. 
